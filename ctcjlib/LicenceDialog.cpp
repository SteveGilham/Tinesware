 ...
 */
#include "com_ravnaandtines_ctcjava_LicenceDialog.h"
#include "basic.h"
#include "licences.h"
#include "utfcode.h"
#include <locale.h>
 ...
 */
extern "C" JNIEXPORT jstring JNICALL Java_com_ravnaandtines_ctcjava_LicenceDialog_getGPL
  (JNIEnv * env, jclass)
{
 ...
 * Signature: ()Ljava/lang/String;
 */
extern "C" JNIEXPORT jstring JNICALL Java_com_ravnaandtines_ctcjava_LicenceDialog_getIDEA
  (JNIEnv * env, jclass)
{
    setlocale(LC_ALL, NULL); // ASCII text => 'C' locale
