...
//FXColorWell
FXColorWell::ColorDialog = "Color Dialog";
...
FXFileSelector::Directory = "Dossier:"; // done
...
FXFileSelector::CopyFileCaption = "Copy File";
...
FXFileSelector::MoveFileCaption = "Move File";
...
FXFileSelector::DeleteFileCaption = "Deleting files";
