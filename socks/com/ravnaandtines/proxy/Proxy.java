package com.ravnaandtines.proxy;
...
import com.ravnaandtines.net.socks5.UDPProxy;
/**
*  Class Proxy - GUI for com.ravnaandtines.net.socks5.UDPProxy
* <p>
    ...
    b.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        Thread t = new Thread( new Runnable() {
          public void run() { try {
            ServerSocket server = new ServerSocket (UDPProxy.port);
            while (true) {
              Socket client = server.accept ();
              UDPProxy echo = new UDPProxy (client);
              echo.setProxies(proxies);
              echo.start ();
            }} catch(java.io.IOException ioe) {return;}
          }});
        UDPProxy.setVerbose(cb.isSelected());
        t.start();
        b.setEnabled(false);
        cb.setEnabled(false);
        ap.lock();
...
//Help | About action performed
  ...
  {
    Proxy_AboutBox dlg = new Proxy_AboutBox(this);
