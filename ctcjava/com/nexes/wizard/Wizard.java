...
public class Wizard extends WindowAdapter implements PropertyChangeListener {
    ...
    public int showModalDialog() {
        ...
        wizardDialog.pack();
        wizardDialog.setLocationRelativeTo(getOwner());
   ...
   /**
    ...
    /**
     * Closes the dialog and sets the return code to the Cancel state.
     */    
    ...
    private void initComponents() {
        ...
        backButton = new JButton();//BACK_TEXT, BACK_ICON);
        nextButton = new JButton();//NEXT_TEXT, NEXT_ICON);
        cancelButton = new JButton();//CANCEL_TEXT, CANCEL_ICON);
