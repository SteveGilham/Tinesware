...
public class NativeSignature
{
    ...
    private NativeSignature(long handle)
    {
        pointer = handle;
    }
    ...
    public NativeSignature nextSignature()
    {
        return getNextSignature(pointer);
    }
    private native NativeSignature getNextSignature(long ptr);
