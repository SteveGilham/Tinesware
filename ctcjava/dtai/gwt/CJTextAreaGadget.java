 ...
 **  And a deviant version spun off
 ****************************************************************/
 ...
 */
public class CJTextAreaGadget extends ScrollPaneGadget implements TextGadget {
    /**
    ...
    private CJLinesPanel linesPanel;

    /**
     * Constructs a new TextAreaGadget.
     */
    public CJTextAreaGadget() {
    	this("",0,0);
    }
     ...
     */
    public CJTextAreaGadget(int rows, int cols) {
    	this("",rows,cols);
    }
     ...
     */
    public CJTextAreaGadget(String text) {
    	this(text,0,0);
    }
     ...
     */
    public CJTextAreaGadget(String text, int rows, int cols) {
     ...
     */
    public CJTextAreaGadget(String text, int rows, int cols, int scrollbarVisibility) {
    	this.rows = rows;
    	this.cols = cols;
    	...
    	setWordWrap(true);
    	linesPanel = new CJLinesPanel(this);
    ...
    /**
     * enquotes the selection
     */
    public void enquote(String quote) {
        linesPanel.enquote(quote);
    }

    /**
     * wraps quoted text to 72 columns
     */
    public void wrapQ() {
        linesPanel.wrapQ();
    }
    ...
    public String getSelectedText() {
    	return linesPanel.getSelectedText(true);
    }
    ...
    public synchronized void removeFocusListener(FocusListener l) {
      ...
      public synchronized void addMouseListener(MouseListener l) {
        linesPanel.addMouseListener(l);
	  }
	  public synchronized void removeMouseListener(MouseListener l) {
        linesPanel.removeMouseListener(l);
	  }


    public void setBounds(int x, int y, int w, int h, boolean notifyParent) {
        if (w != width || h != height) {
            CJLinesPanel linesPanel = this.linesPanel;
            if (linesPanel != null) {
