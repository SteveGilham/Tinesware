 ...
 */
public class TextFieldGadget extends BorderGadget implements TextGadget, Runnable {
   ...
   /**
	...
	public TextFieldGadget(String text, int columns) {
	    this(text,columns,new TextLine());
	}
	 ...
	 * @param line - TBD
	 */
	protected TextFieldGadget(String text, int columns, TextLine line) {
	    this.line = line;
	    add("Center",line);
	    setColumns( columns );
	    setText( text );
    ...
    protected void processKeyEvent(KeyEvent e) {
        if (e.getID() == KeyEvent.KEY_PRESSED) {
            if (dtai.util.Debug.getLevel() == 80) {
                System.err.println("e.isActionKey()="+e.isActionKey()+" e.getKeyCode()="+e.getKeyCode()+" e.getKeyChar()="+((int)e.getKeyChar()));
            }
